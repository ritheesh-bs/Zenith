...
var PKCE = /*#__PURE__*/function () {
  function PKCE() {
    _classCallCheck(this, PKCE);
  }
  _createClass(PKCE, [{
    key: "generateAuthorizationURL",
    value:
    /**
     ...
     */
    function generateAuthorizationURL(client, options, codeChallenge) {
      var start_page = options.start_page,
        state = options.state,
        is_create_org = options.is_create_org,
        org_code = options.org_code,
        org_name = options.org_name,
        lang = options.lang,
        login_hint = options.login_hint,
        connection_id = options.connection_id;
      var searchParams = _objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread(_objectSpread({
      ...
      return "".concat(client.authorizationEndpoint, "?").concat(new URLSearchParams(searchParams).toString());
    }
    ...
    key: "getToken",
    value: function () {
      var _getToken = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(client, code, codeVerifier) {
        var searchParams, res, token;
        return _regeneratorRuntime().wrap(function _callee$(_context) {
          while (1) switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 3;
              return fetch(client.tokenEndpoint, {
                method: 'POST',
                headers: {
                  'Content-Type': 'application/x-www-form-urlencoded',
                  'Kinde-SDK': "".concat(client.kindeSdkLanguage, "/").concat(client.kindeSdkLanguageVersion)
                },
