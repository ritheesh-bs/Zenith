...
export default function FeedbackModal() {
    ...
    return (
        <div className="flex text-sm flex-col w-full items-center h-dvh justify-center fixed inset-0 bg-white dark:bg-black bg-opacity-10 backdrop-blur-[200px] z-10">
            {status === "default" && (
